...
import           Stack.Runners ( ShouldReexec (..), withConfig, withEnvConfig , withDebugEnvConfig)
...
initGhcCmd :: BuildOptsCLI -> RIO Runner ()
initGhcCmd opts = do
    void $ withConfig YesReexec $ withDebugEnvConfig NeedTargets opts $
      Stack.InitGhc.build Nothing
